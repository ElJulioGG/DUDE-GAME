...
public class BulletBehavior : MonoBehaviour
{
    ...
    {
        // Mueve la posici�n de la bala justo al punto de colisi�n
        rb.position = targetPoint;
        transform.position = targetPoint;

        // Si necesitas ajustar la direcci�n antes de desaparecer (como en rebotes agotados)
        ...
        yield return null; // Espera un frame para que la part�cula se actualice
